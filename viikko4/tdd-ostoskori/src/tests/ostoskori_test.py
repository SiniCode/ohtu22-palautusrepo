...
class TestOstoskori(unittest.TestCase):
    ...
    def test_kahden_eri_tuotteen_lisaamisen_jalkeen_ostoskorissa_on_kaksi_tavaraa(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.kaakao)
    ...
    def test_kahden_saman_tuotteen_lisaamisen_jalkeen_ostoskorissa_on_yksi_ostos(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
    ...
    def test_saman_tuotteen_lisaamisen_jalkeen_korissa_yksi_ostosolio_jolla_oikea_tuotteen_nimi_ja_maara(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
    ...
    def test_kahden_saman_tuotteen_ja_toisen_poistamisen_jalkeen_korissa_on_ostos_jossa_lukumäärä_on_yksi(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
    ...
    def test_kori_on_tyhja_yhden_tuotteen_lisaamisen_ja_saman_tuotteen_poistamisen_jalkeen(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.poista_tuote(self.maito)
